...
ARG MODULE
COPY --from=sdk automation-workspace/web/$MODULE/build/libs/automation-qa*.jar automation-workspace/microservices/$MODULE/build/libs/automation-qa*.jar ./automation-tests.jar/