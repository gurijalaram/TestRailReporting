...
pipeline {
    parameters {
        ...
        choice(name: 'MODULE_PROP', choices: ['customer-smoke', 'cic-qa', 'cas-int', 'cas-qa', 'cid-int', 'cid-qa', 'cidapp-int', 'staging', 'cia-qa-21-1'], description: 'What is the module properties file?')
