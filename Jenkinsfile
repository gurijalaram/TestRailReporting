...
pipeline {
    parameters {
        ...
        choice(name: 'MODULE_PROP', choices: ['cid-aut', 'cid-te', 'cid-perf', 'customer-smoke', 'cic-qa', 'cas-int', 'cas-qa', 'cid-int', 'cid-qa', 'cidapp-qa'], description: 'What is the module properties file?')
