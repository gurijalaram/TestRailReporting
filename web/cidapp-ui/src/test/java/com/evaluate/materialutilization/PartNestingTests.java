...
public class PartNestingTests extends TestBase {
    ...
    public void partNestingTabRectangularNesting() {
        ...
        assertThat(partNestingPage.closePanel().isCostLabel(NewCostingLabelEnum.COST_UP_TO_DATE), is(true));
    }
    ...
    public void partNestingTabDisabled() {
        ...
        loginPage = new CidAppLoginPage(driver);
        MaterialProcessPage materialProcessPage;
