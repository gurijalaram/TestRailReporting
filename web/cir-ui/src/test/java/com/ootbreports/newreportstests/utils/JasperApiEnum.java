...
public enum JasperApiEnum {
    ...
    SCENARIO_ACTIVITY("/scenarioactivity/ScenarioActivityReportRequest"),
    SCENARIO_ACTIVITY_DIGITAL_FACTORY_ACTIVITY("/scenarioactivity/ScenarioActivityDigitalFactoryActivityReportRequest"),
    SCENARIO_ACTIVITY_MATERIAL_ACTIVITY("/scenarioactivity/ScenarioActivityMaterialActivityReportRequest"),
    SCENARIO_ACTIVITY_PROCESS_ACTIVITY("/scenarioactivity/ScenarioActivityProcessActivityReportRequest"),
    SCENARIO_ACTIVITY_PROCESS_GROUP_ACTIVITY("/scenarioactivity/ScenarioActivityProcessGroupActivityReportRequest"),
    SCENARIO_ACTIVITY_TOTAL_ACTIVITY("/scenarioactivity/ScenarioActivityTotalActivityReportRequest"),
