...
public class SheetMetalDtcReportTests extends JasperApiAuthenticationUtil {
    ...
    public void testCurrencyCode() {
        ...
        ChartDataPoint usdChartDataPoint = jasperApiUtils.generateReportAndGetChartDataPoint(reportRequest, "3574715 (Bulkload)");
        ...
        ChartDataPoint gbpChartDataPoint = jasperApiUtils.generateReportAndGetChartDataPoint(reportRequest, "3574715 (Bulkload)");
