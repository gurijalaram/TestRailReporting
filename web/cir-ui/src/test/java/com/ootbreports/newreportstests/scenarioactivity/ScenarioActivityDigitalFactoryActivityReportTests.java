...
public class ScenarioActivityDigitalFactoryActivityReportTests extends JasperApiAuthenticationUtil {
    private static final String reportsJsonFileName = JasperApiEnum.SCENARIO_ACTIVITY_DIGITAL_FACTORY_ACTIVITY.getEndpoint();
    private static final CirApiEnum reportsNameForInputControls = CirApiEnum.SCENARIO_ACTIVITY_DIGITAL_FACTORY_ACTIVITY;
    ...
    public void testTrendingPeriod() {
        ...
        ArrayList<Element> dateElementsDaily = jasperReportSummaryDaily.getReportHtmlPart().getElementsContainingText("Digital Factory").get(8).children();
        ArrayList<Element> dateElementsYearly = jasperReportSummaryYearly.getReportHtmlPart().getElementsContainingText("Digital Factory").get(8).children();
