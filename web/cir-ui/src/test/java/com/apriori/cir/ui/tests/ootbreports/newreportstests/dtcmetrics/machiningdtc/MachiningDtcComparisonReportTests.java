...
public class MachiningDtcComparisonReportTests extends JasperApiAuthenticationUtil {
    ...
    private JasperApiInputControlsPathEnum reportsNameForInputControls = JasperApiInputControlsPathEnum.MACHINING_DTC_COMPARISON;
    ...
    public void testProcessGroupFunctionalityTwoModelMachining() {
        ...
        jasperApiUtils.genericProcessGroupDtcTest(
            partNames,
            InputControlsEnum.PROCESS_GROUP.getInputControlId(), ProcessGroupEnum.TWO_MODEL_MACHINING.getProcessGroup()
        );
    }
    ...
    public void testProcessGroupFunctionalityStockMachining() {
        ...
        jasperApiUtils.genericProcessGroupDtcTest(
            partNames,
            InputControlsEnum.PROCESS_GROUP.getInputControlId(), ProcessGroupEnum.STOCK_MACHINING.getProcessGroup()
        );
    }
    ...
    public void testSortOrderDesignStandards() {
        ...
        jasperApiUtils.genericSortOrderDtcComparisonTest(
            partNames,
            InputControlsEnum.SORT_ORDER.getInputControlId(), SortOrderEnum.DESIGN_STANDARDS.getSortOrderEnum()
        );
    }
