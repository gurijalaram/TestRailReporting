...
public enum JasperCirApiPartsEnum {
    ...
    DASHBOARD_PART1("DASHBOARD_PART1"),
    DASHBOARD_PART2("DASHBOARD_PART2"),
    AP_SHEET_METAL_EXERCISE("AP_SHEETMETAL_EXERCISE (Initial)"),
    P_3574715_BULK_LOAD("3574715 (Bulkload)"),
    VERY_LONG_NAME_01234567890123456789012345678901234567890123456789("VERY LONG NAME 01234567890123456789012345678901234567890123456789");
