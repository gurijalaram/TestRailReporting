...
public class TwoModelMachiningTests extends TestBaseUI {
    ...
    public void testOpenSourceModel() {
        ...
        ComponentInfoBuilder twoModelPart = new ComponentRequestUtil().getUniqueComponent("VulcainMachined");
        twoModelPart.setUser(sourcePart.getUser());
    ...
    public void multiLevel2Model() {
        ...
        ComponentInfoBuilder twoModel = new ComponentRequestUtil().getUniqueComponent("2modeltest-machine1");
        twoModel.setUser(sourcePart.getUser());
        ComponentInfoBuilder twoModel2 = new ComponentRequestUtil().getUniqueComponent("2modeltest-machine2");
    ...
    public void testOpenPublicSourceModel() {
        ...
        ComponentInfoBuilder twoModelPartName = new ComponentRequestUtil().getUniqueComponent("Machined Casting");
    ...
    public void switchSourcePart() {
        ...
        ComponentInfoBuilder twoModel = new ComponentRequestUtil().getUniqueComponent("Die Casting Lower Control Arm (As Machined2)");
        twoModel.setUser(sourcePart.getUser());
    ...
    public void selectSourceButtonDisabledInPublicWorkspace() {
        ...
        ComponentInfoBuilder twoModelPart = new ComponentRequestUtil().getUniqueComponent("Machined Casting");
        twoModelPart.setUser(sourcePart.getUser());
