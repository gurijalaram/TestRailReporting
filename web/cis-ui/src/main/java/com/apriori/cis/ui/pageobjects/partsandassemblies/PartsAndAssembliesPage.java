package com.apriori.cis.ui.pageobjects.partsandassemblies;

import com.apriori.cis.ui.common.PartsAndAssemblyFilterController;
import com.apriori.cis.ui.common.PartsAndAssemblyTableController;
...
public class PartsAndAssembliesPage extends EagerPageComponent<PartsAndAssembliesPage> {
    ...
    public PartsAndAssembliesDetailsPage clickOnComponent(String componentName, String scenarioName) {
        String selector = String.format("//div[@role='row']//div[@data-field='componentName']//p[text()='%s']", componentName);
