...
import com.apriori.cmp.api.models.response.ErrorResponse;
...
public class CmpSaveComparisonTests {
    ...
    public void testCreateThenUpdateComparison() {
        ...
        PostComparisonResponse savedComparisonResponse = comparisonUtils.createComparison(comparison, component1.getUser(), PostComparisonResponse.class, HttpStatus.SC_CREATED);
        ...
        GetComparisonResponse getComparisonDetails = comparisonUtils.getComparison(component1.getUser(), savedComparisonResponse.getIdentity());
        ...
        GetComparisonResponse updatedComparison = comparisonUtils.updateComparison(
            updateComparison, component1.getUser(), GetComparisonResponse.class, HttpStatus.SC_OK, getComparisonDetails.getIdentity());
    ...
    public void testCreateComparisonValidation() {
        ...
        ErrorResponse savedComparisonResponse = comparisonUtils.createComparison(comparison, component1.getUser(), ErrorResponse.class, HttpStatus.SC_BAD_REQUEST);
        ...
        savedComparisonResponse = comparisonUtils.createComparison(comparison, component1.getUser(), ErrorResponse.class, HttpStatus.SC_BAD_REQUEST);
    ...
    public void testUpdateComparisonValidation() {
        ...
        ErrorResponse updatedComparison = comparisonUtils.updateComparison(
            comparisonUpdates, component1.getUser(), ErrorResponse.class, HttpStatus.SC_BAD_REQUEST, savedComparisonResponse.getIdentity());
        ...
        updatedComparison = comparisonUtils.updateComparison(comparisonUpdates, component1.getUser(), ErrorResponse.class, HttpStatus.SC_BAD_REQUEST, savedComparisonResponse.getIdentity());
