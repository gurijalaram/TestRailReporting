...
public class UserPreferencesUtil {
    ...
    public ResponseWrapper<String> patchPreference(UserCredentials userCredentials, PreferencesEnum preference, String value) {
        RequestEntity responseEntity = RequestEntityUtil_Old.init(CusAppAPIEnum.PREFERENCES, PreferenceItemsResponse.class)
        ...
        RequestEntity requestEntity = RequestEntityUtil_Old.init(CusAppAPIEnum.PREFERENCES, null)
            .token(userCredentials.getToken())
    ...
    public PreferencesResponse updatePreferences(UserCredentials userCredentials, Map<PreferencesEnum, String> preferences) {
        ...
        RequestEntity requestEntity = RequestEntityUtil_Old.init(CidAppAPIEnum.PREFERENCES, PreferencesResponse.class)
            .token(userCredentials.getToken())
