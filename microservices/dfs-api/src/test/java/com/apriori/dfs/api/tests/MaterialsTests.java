...
public class MaterialsTests {
    ...
    public void setup() {
        ...
        materialUtil = new MaterialUtil(requestEntityUtil);
    }
    ...
    public void getMaterialWithIncorrectAcceptHeader() {
        RequestEntity requestEntity = requestEntityUtil.init(DFSApiEnum.MATERIAL_BY_PATH, ErrorMessage.class)
    ...
    public void findMaterialsWithIncorrectAcceptHeader() {
        RequestEntity requestEntity = requestEntityUtil.init(DFSApiEnum.MATERIALS, ErrorMessage.class)
