...
public class MaterialStocksTests {
    ...
    private MaterialStockUtil materialStockUtil;
    private RequestEntityUtil requestEntityUtil;

    @BeforeEach
    public void setup() {
        requestEntityUtil = TestHelper.initUser(APRIORI_DESIGNER);
        materialStockUtil = new MaterialStockUtil(requestEntityUtil);
    }
    ...
    public void getMaterialStockWithIncorrectAcceptHeader() {
        RequestEntity requestEntity = requestEntityUtil.init(DFSApiEnum.MATERIAL_STOCKS_BY_PATH, ErrorMessage.class)
    ...
    public void findMaterialStocksWithIncorrectAcceptHeader() {
        RequestEntity requestEntity = requestEntityUtil.init(DFSApiEnum.MATERIAL_STOCKS, ErrorMessage.class)
