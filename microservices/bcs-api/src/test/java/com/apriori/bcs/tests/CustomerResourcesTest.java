...
public class CustomerResourcesTest {
    ...
    public void getUserPreferences() {
        ResponseWrapper<UserPreferences> costingPreferencesResponse = HTTPRequest
            .build(CustomerResources.getCustomerRequestEntity(BCSAPIEnum.CUSTOMER_USER_PREFERENCES, UserPreferences.class))
            .get();
    ...
    public void getProcessGroups() {
        ResponseWrapper<ProcessGroups> processGroupsResponse = HTTPRequest
            .build(CustomerResources.getCustomerRequestEntity(BCSAPIEnum.CUSTOMER_PROCESS_GROUPS, ProcessGroups.class))
            .get();
    ...
    public void getUserDefinedAttributes() {
        ResponseWrapper<UserDefinedAttributes> userDefinedAttributesResponse = HTTPRequest
            .build(CustomerResources.getCustomerRequestEntity(BCSAPIEnum.CUSTOMER_USER_DEFINED_ATTRIBUTES, UserDefinedAttributes.class))
            .get();
    ...
    public void getVirtualProductionEnvironments() {
        ResponseWrapper<CustomerVPE> customerVPEResponse = HTTPRequest
            .build(CustomerResources.getCustomerRequestEntity(BCSAPIEnum.CUSTOMER_VPEs, CustomerVPE.class))
            .get();
    ...
    public void patchUserPreferences() {
        ResponseWrapper<UserPreferences> costingPreferencesResponse = CustomerResources.patchCostingPreferences();
        assertThat(costingPreferencesResponse.getStatusCode(), is(equalTo(HttpStatus.SC_OK)));
    }
    ...
    public void getDigitalFactories() {
        ResponseWrapper<DigitalFactories> digitalFactoriesResponse = HTTPRequest
            .build(CustomerResources.getCustomerRequestEntity(BCSAPIEnum.CUSTOMER_DIGITAL_FACTORIES, DigitalFactories.class))
            .get();
    ...
    public void getCustomAttributes() {
        ResponseWrapper<CustomAttributes> customAttributesResponse = HTTPRequest
            .build(CustomerResources.getCustomerRequestEntity(BCSAPIEnum.CUSTOMER_CUSTOM_ATTRIBUTES, CustomAttributes.class))
            .get();
