...
import com.apriori.report.api.controller.ReportReplicaUtil;
...
public class ReportTests {
    ...
    public void testReportReplica() {
        ...
        ReportReplicaUtil reportReplicaUtil = new ReportReplicaUtil(TestHelper.initUser());
        Report postResponse = reportReplicaUtil.postExecuteReport(customerId);

        Report reportResponse = reportReplicaUtil.getReportStatus(customerId, postResponse.getExecutionId());
        ...
        List<ReportBean> reportCsv = reportReplicaUtil.downloadReadReport(reportResponse.getUrl(), '|', ReportBean.class);
