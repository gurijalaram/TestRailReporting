...
import com.apriori.cisapi.entity.response.PostComponentResponse;
import com.apriori.cisapi.entity.response.Successes;
import com.apriori.entity.request.ComponentRequest;
import com.apriori.entity.response.CadFile;
import com.apriori.entity.response.CadFilesResponse;
...
public class ComponentsUtil {
    ...
    private ResponseWrapper<CadFilesResponse> postCadFile(ComponentInfoBuilder componentBuilder, List<File> files) {
        RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.CAD_FILES, CadFilesResponse.class)
    ...
    public ResponseWrapper<PostComponentResponse> postComponent(ComponentInfoBuilder componentBuilder) {
        ...
        RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.COMPONENTS_CREATE, PostComponentResponse.class)
                .body("groupItems",
    ...
    public ComponentInfoBuilder postMultiComponentsQueryCss(ComponentInfoBuilder componentInfoBuilder) {
        ...
        RequestEntity requestEntity = RequestEntityUtil.init(CisAPIEnum.COMPONENTS_CREATE, PostComponentResponse.class)
    ...
    public ResponseWrapper<GetComponentResponse> getComponents() {
        RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.COMPONENTS, GetComponentResponse.class);
    ...
    public ResponseWrapper<ComponentIdentityResponse> getComponentIdentity(ComponentInfoBuilder componentInfo) {
        RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.COMPONENTS_BY_COMPONENT_ID, ComponentIdentityResponse.class)
    ...
    public ResponseWrapper<ComponentIteration> getComponentIterationLatest(ComponentInfoBuilder componentInfo) {
        RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.COMPONENT_ITERATION_LATEST_BY_COMPONENT_SCENARIO_IDS, ComponentIteration.class)
