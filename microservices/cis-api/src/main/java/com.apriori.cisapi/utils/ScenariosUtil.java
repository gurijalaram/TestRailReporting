...
import com.apriori.cisapi.entity.request.CostRequest;
import com.apriori.cisapi.entity.request.ForkRequest;
import com.apriori.cisapi.entity.request.GroupCostRequest;
import com.apriori.cisapi.entity.request.GroupItems;
import com.apriori.cisapi.entity.request.GroupPublishRequest;
import com.apriori.cisapi.entity.request.PublishRequest;
import com.apriori.cisapi.entity.request.ScenarioAssociationGroupItems;
import com.apriori.cisapi.entity.request.ScenarioAssociationsRequest;
import com.apriori.cisapi.entity.request.ScenarioRequest;
import com.apriori.cisapi.entity.response.AssociationSuccessesFailures;
import com.apriori.cisapi.entity.response.GroupCostResponse;
import com.apriori.cisapi.entity.response.ImageResponse;
import com.apriori.cisapi.entity.response.Options;
import com.apriori.cisapi.entity.response.Scenario;
import com.apriori.cisapi.entity.response.ScenarioManifest;
import com.apriori.cisapi.entity.response.ScenarioManifestSubcomponents;
import com.apriori.cisapi.entity.response.ScenarioResponse;
import com.apriori.cisapi.entity.response.ScenarioSuccessesFailures;
...
public class ScenariosUtil {
    ...
    private ResponseWrapper<ScenarioResponse> scenarioRequestEntity(ComponentInfoBuilder componentInfo) {
        ...
        RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.SCENARIO_REPRESENTATION_BY_COMPONENT_SCENARIO_IDS, ScenarioResponse.class)
    ...
    public ResponseWrapper<ScenarioResponse> postCostComponent(ComponentInfoBuilder componentInfo) {
        RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.COMPONENT_BY_COMPONENT_SCENARIO_IDS, ScenarioResponse.class)
    ...
    public ResponseWrapper<ImageResponse> getHoopsImage(String componentIdentity, String scenarioIdentity) {
        RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.HOOPS_IMAGE_BY_COMPONENT_SCENARIO_IDS, ImageResponse.class)
    ...
    public ResponseWrapper<ScenarioResponse> postCostScenario(ComponentInfoBuilder componentInfo) {
        final RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.COST_SCENARIO_BY_COMPONENT_SCENARIO_IDs, Scenario.class)
                .token(componentInfo.getUser().getToken())
                .inlineVariables(componentInfo.getComponentIdentity(), componentInfo.getScenarioIdentity())
                .body("costingInputs",
                    CostRequest.builder()
    ...
    public ResponseWrapper<Scenario> postCopyScenario(ComponentInfoBuilder componentInfo) {
        final RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.COPY_SCENARIO_BY_COMPONENT_SCENARIO_IDs, Scenario.class)
                .token(componentInfo.getUser().getToken())
                .inlineVariables(componentInfo.getComponentIdentity(), componentInfo.getScenarioIdentity())
                .body("scenario",
    ...
    public ResponseWrapper<Scenario> postEditScenario(ComponentInfoBuilder componentInfo, ForkRequest forkRequest) {
        final RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.EDIT_SCENARIO_BY_COMPONENT_SCENARIO_IDs, Scenario.class)
                .inlineVariables(componentInfo.getComponentIdentity(), componentInfo.getScenarioIdentity())
    ...
    public ResponseWrapper<ScenarioSuccessesFailures> postEditGroupScenarios(ComponentInfoBuilder componentInfo, ForkRequest forkRequest, String... componentScenarioName) {
        ...
        final RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.EDIT_SCENARIOS, ScenarioSuccessesFailures.class)
    ...
    public ResponseWrapper<GroupCostResponse> postGroupCostScenarios(ComponentInfoBuilder componentInfo, String... componentScenarioName) {
        ...
        final RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.GROUP_COST_COMPONENTS, GroupCostResponse.class)
    ...
    public ResponseWrapper<ErrorMessage> postGroupCostNullScenarios(ComponentInfoBuilder componentInfo) {
        ...
        final RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.GROUP_COST_COMPONENTS, ErrorMessage.class)
                .body(GroupCostRequest.builder()
                    .costingTemplateIdentity("")
    ...
    private Scenario postCostingTemplate(ComponentInfoBuilder componentInfo) {
        final RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.COSTING_TEMPLATES, Scenario.class)
                .token(componentInfo.getUser().getToken())
    ...
    public <T> ResponseWrapper<ScenarioResponse> publishScenario(ComponentInfoBuilder componentInfo, Class<T> klass) {
        final RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.PUBLISH_SCENARIO, klass)
                .token(componentInfo.getUser().getToken())
                .inlineVariables(componentInfo.getComponentIdentity(), componentInfo.getScenarioIdentity())
    ...
    public ResponseWrapper<ScenarioSuccessesFailures> postPublishGroupScenarios(GroupPublishRequest groupPublishRequest, String... componentScenarioName) {
        ...
        final RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.PUBLISH_SCENARIOS, ScenarioSuccessesFailures.class)
    ...
    public <T> ResponseWrapper<ErrorMessage> deleteScenario(String componentIdentity, String scenarioIdentity, UserCredentials userCredentials) {
        ...
        final RequestEntity deleteRequest =
            genericDeleteRequest(userCredentials, CisAPIEnum.SCENARIO_BY_COMPONENT_SCENARIO_ID, null, componentIdentity, scenarioIdentity);

        HTTPRequest.build(deleteRequest).delete();

        RequestEntity scenarioRequest =
            genericDeleteRequest(userCredentials, CisAPIEnum.SCENARIO_REPRESENTATION_BY_COMPONENT_SCENARIO_IDS, null, componentIdentity, scenarioIdentity);
        ...
        try {
            do {
                ...
                if (!scenarioResponse.getBody().contains("response")) {
                    ...
                    RequestEntity requestEntity =
                        genericDeleteRequest(userCredentials, CisAPIEnum.SCENARIO_BY_COMPONENT_SCENARIO_ID, ErrorMessage.class, componentIdentity, scenarioIdentity);
    ...
    private <T> RequestEntity genericDeleteRequest(UserCredentials userCredentials, CisAPIEnum endPoint, Class<T> klass, String componentId, String scenarioId) {
        final int SOCKET_TIMEOUT = 240000;
    ...
    public ResponseWrapper<ScenarioManifest> getScenarioManifest(ComponentInfoBuilder componentInfo) {
        final RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.MANIFEST_SCENARIO_BY_COMPONENT_SCENARIO_IDs, ScenarioManifest.class)
                .token(componentInfo.getUser().getToken())
                .inlineVariables(componentInfo.getComponentIdentity(), componentInfo.getScenarioIdentity());
    ...
    public ResponseWrapper<AssociationSuccessesFailures> patchAssociations(ComponentInfoBuilder componentInfo, boolean excluded, String... componentScenarioName) {
        ...
        final RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.SCENARIO_ASSOCIATIONS, AssociationSuccessesFailures.class)
                .inlineVariables(componentInfo.getComponentIdentity(), componentInfo.getScenarioIdentity())
    ...
    public <T> ResponseWrapper<T> patchAssociations(ComponentInfoBuilder componentInfo, List<ScenarioAssociationGroupItems> scenarioManifestSubcomponents, Class<T> klass) {
        ...
        final RequestEntity requestEntity =
            RequestEntityUtil.init(CisAPIEnum.SCENARIO_ASSOCIATIONS, klass)
                .inlineVariables(componentInfo.getComponentIdentity(), componentInfo.getScenarioIdentity())
                .body(ScenarioAssociationsRequest.builder()
