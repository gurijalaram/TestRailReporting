...
public class CisBidPackageTest extends TestUtil {
    ...
    public void getBidPackageFromOtherUser() {
        ...
        CisErrorMessage qmsErrorMessageResponse = CisBidPackageResources.getBidPackage(bidPackageResponse.getIdentity(), CisErrorMessage.class, HttpStatus.SC_NOT_FOUND, otherUser);
    ...
    public void getBidPackageWithAddedPackageItem() {
        ...
        BidPackageProjectResponse bidPackageProjectResponse = CisBidPackageResources.createBidPackageProject(bidProjectName, bidPackageResponse.getIdentity(), BidPackageProjectResponse.class, HttpStatus.SC_CREATED, currentUser);
        softAssertions.assertThat(bidPackageProjectResponse.getName()).isEqualTo(bidProjectName);

        BidPackageResponse getBidPackageProjectResp = CisBidPackageResources.getBidPackage(bidPackageResponse.getIdentity(), BidPackageResponse.class, HttpStatus.SC_OK, currentUser);
