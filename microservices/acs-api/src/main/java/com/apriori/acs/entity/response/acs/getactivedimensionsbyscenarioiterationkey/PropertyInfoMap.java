...
public class PropertyInfoMap {
    ...
    private PropertyInfoItem engineType;
    private PropertyInfoItem cadVersion;
    private PropertyInfoItem numSurfaces;
    private PropertyInfoItem descriptor;
    private PropertyInfoItem cadConfiguration;
    ...
    private PropertyInfoItem thicknessStdDev;
    private PropertyInfoItem averageThickness;
    private PropertyInfoItem length;
    private PropertyInfoItem childArtifactCount;
    private PropertyInfoItem timeUnitName;
    private PropertyInfoItem maxThickness;
    private PropertyInfoItem massUnitName;
    ...
    private PropertyInfoItem partModelName;
    private PropertyInfoItem min80Thickness;
    private PropertyInfoItem temperatureUnitName;
    private PropertyInfoItem fileFormat;
