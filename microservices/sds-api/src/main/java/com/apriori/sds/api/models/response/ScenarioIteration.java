...
import com.apriori.shared.util.models.response.component.CostingInput;
import com.apriori.shared.util.models.response.component.Thumbnail;
import com.apriori.shared.util.models.response.component.componentiteration.AnalysisOfScenario;
import com.apriori.shared.util.models.response.component.componentiteration.PartNestingDiagram;
import com.apriori.shared.util.models.response.component.componentiteration.ScenarioCustomAttribute;
import com.apriori.shared.util.models.response.component.componentiteration.ScenarioDesignInvestigations;
import com.apriori.shared.util.models.response.component.componentiteration.ScenarioDesignIssues;
import com.apriori.shared.util.models.response.component.componentiteration.ScenarioDesignNotices;
import com.apriori.shared.util.models.response.component.componentiteration.ScenarioGcd;
import com.apriori.shared.util.models.response.component.componentiteration.ScenarioMetadata;
import com.apriori.shared.util.models.response.component.componentiteration.ScenarioProcess;
import com.apriori.shared.util.models.response.component.componentiteration.ScenarioRoutings;
