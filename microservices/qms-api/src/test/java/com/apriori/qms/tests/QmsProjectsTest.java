...
public class QmsProjectsTest extends TestUtil {
    ...
    @Test
    @TestRail(testCaseId = {"25991"})
    @Description("Create Project with ownerUserIdentity of the Current User in the request")
    public void createProjectWithOwnerUserIdentityCurrentUser() {
        List<BidPackageItemRequest> itemsList = new ArrayList<>();
        itemsList.add(BidPackageItemRequest.builder()
            .bidPackageItem(BidPackageItemParameters.builder()
                .componentIdentity(scenarioItem.getComponentIdentity())
        ...
        projectAttributesMap.put("projectOwnerUserIdentity", new AuthUserContextUtil().getAuthUserIdentity(currentUser.getEmail()));
        BidPackageProjectResponse bppResponse = QmsProjectResources.createProject(projectAttributesMap,
            itemsList,
            usersList,
            BidPackageProjectResponse.class,
            HttpStatus.SC_CREATED,
        ...
        softAssertions.assertThat(bppResponse.getOwnerUserIdentity()).isEqualTo(new AuthUserContextUtil().getAuthUserIdentity(currentUser.getEmail()));
    }

    @Test
    @TestRail(testCaseId = {"25992"})
    @Description("Create Project with ownerUserIdentity other than Current User in the request")
    public void createProjectWithOwnerUserIdentityNotCurrentUser() {
        List<BidPackageItemRequest> itemsList = new ArrayList<>();
        itemsList.add(BidPackageItemRequest.builder()
            .bidPackageItem(BidPackageItemParameters.builder()
                .componentIdentity(scenarioItem.getComponentIdentity())
        ...
        HashMap<String, String> projectAttributesMap = new HashMap<>();
        projectAttributesMap.put("projectOwnerUserIdentity", new AuthUserContextUtil().getAuthUserIdentity(firstUserEmail));
        BidPackageProjectResponse bppResponse = QmsProjectResources.createProject(projectAttributesMap,
            itemsList,
            usersList,
            BidPackageProjectResponse.class,
