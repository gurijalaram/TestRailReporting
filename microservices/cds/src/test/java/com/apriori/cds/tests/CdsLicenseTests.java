...
public class CdsLicenseTests extends CdsTestUtil {
    ...
    public void getCustomerLicense() {
        ...
        ResponseWrapper<Licenses> license = getCommonRequest(customerLicenseEndpoint,  Licenses.class);
    ...
    public void getCustomerLicenseByIdentity() {
        ...
        ResponseWrapper<LicenseResponse> licenseResponse = getCommonRequest(licenseIdentityEndpoint,  LicenseResponse.class);
