...
public class CdsInstallationsTests extends CdsTestUtil {
    ...
    public void getInstallations() {
        ...
        ResponseWrapper<InstallationResponse> response = getCommonRequest(url,  InstallationResponse.class);
    ...
    public void addCustomerInstallation() {
        ...
        ResponseWrapper<InstallationItems> installation = addInstallation(customerIdentity, deploymentIdentity, realmKey, cloudRef);
    ...
    public void getInstallationByIdentity() {
        ...
        ResponseWrapper<InstallationItems> identity = getCommonRequest(installationIdentityEndpoint,  InstallationItems.class);
