...
public class CdsCustomersTests extends CdsTestUtil {
    ...
    public void getCustomers() {
        ...
        ResponseWrapper<Customers> response = getCommonRequest(url, Customers.class);
    ...
    public void getCustomerByIdentity() {
        ...
        ResponseWrapper<Customer> response = getCommonRequest(customerIdentityEndpoint, Customer.class);
    ...
    public void getCustomersApplications() {
        ...
        ResponseWrapper<Applications> response = getCommonRequest(applicationsEndpoint, Applications.class);
