...
public class CdsUsersTests extends CdsTestUtil {
    ...
    public void getUsers() {
        ...
        ResponseWrapper<Users> response = getResponse(url, Users.class);
    ...
    public void getUserById() {
        ...
        ResponseWrapper<Users> responseWrapper = getResponse(usersUrl, Users.class);
        ...
        ResponseWrapper<User> response = getResponse(identityUrl, User.class);
    ...
    public void getUsersCredentials() {
        ...
        ResponseWrapper<CredentialsItems> response = getResponse(credentialsUrl, CredentialsItems.class);
