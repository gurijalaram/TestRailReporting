...
public class CdsSitesTests extends CdsTestUtil {
    ...
    public void getSites() {
        ...
        ResponseWrapper<Sites> response = get(url, Sites.class);
    ...
    public void getSiteByIdentity() {
        ...
        ResponseWrapper<Sites> response = get(sitesUrl, Sites.class);
        ...
        ResponseWrapper<Site> responseWrapper = get(identityUrl, Site.class);
    ...
    public void getCustomerSites() {
        ...
        ResponseWrapper<Sites> response = get(siteEndpoint, Sites.class);
    ...
    public void getCustomerSiteDetails() {
        ...
        ResponseWrapper<Site> response = get(identityEndpoint, Site.class);
        assertThat(response.getStatusCode(), is(equalTo(HttpStatus.SC_OK)));
        assertThat(site.getResponseEntity().getResponse().getName(), is(equalTo(siteName)));
