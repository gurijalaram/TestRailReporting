...
public enum CDSRolesEnum {
    CONTRIBUTOR("APRIORI_CONTRIBUTOR", Arrays.asList(AppAccessControlsEnum.CUS,
        AppAccessControlsEnum.ACH, AppAccessControlsEnum.AW)),
    ANALYST("APRIORI_ANALYST", Arrays.asList(AppAccessControlsEnum.CUS,
        AppAccessControlsEnum.ACH, AppAccessControlsEnum.AW, AppAccessControlsEnum.AA)),
    DESIGNER("APRIORI_DESIGNER", Arrays.asList(AppAccessControlsEnum.CUS,
    ...
    DEVELOPER("APRIORI_DEVELOPER", Arrays.asList(AppAccessControlsEnum.CUS,
        AppAccessControlsEnum.ACH, AppAccessControlsEnum.AW, AppAccessControlsEnum.AA, AppAccessControlsEnum.AD,
        AppAccessControlsEnum.FMS, AppAccessControlsEnum.ACS, AppAccessControlsEnum.EDC, AppAccessControlsEnum.AP)),
    EXPERT("APRIORI_EXPERT", Arrays.asList(AppAccessControlsEnum.CUS,
        AppAccessControlsEnum.ACH, AppAccessControlsEnum.AW, AppAccessControlsEnum.AA, AppAccessControlsEnum.AD,
        AppAccessControlsEnum.FMS, AppAccessControlsEnum.ACS, AppAccessControlsEnum.EDC, AppAccessControlsEnum.AP)),
    ANALYST_CONNECT("APRIORI_ANALYST + CONNECT ADMIN", Arrays.asList(AppAccessControlsEnum.CUS,
        AppAccessControlsEnum.ACH, AppAccessControlsEnum.AW, AppAccessControlsEnum.AA, AppAccessControlsEnum.AC)),
    DESIGNER_CONNECT_USER("APRIORI_DESIGNER + CONNECT ADMIN + USER ADMIN", Arrays.asList(AppAccessControlsEnum.CUS,
        AppAccessControlsEnum.ACH, AppAccessControlsEnum.AW, AppAccessControlsEnum.AA, AppAccessControlsEnum.AD,
        AppAccessControlsEnum.FMS, AppAccessControlsEnum.ACS, AppAccessControlsEnum.AC, AppAccessControlsEnum.CA)),
    EXPERT_CONNECT_USER("APRIORI_EXPERT + CONNECT ADMIN + USER ADMIN", Arrays.asList(AppAccessControlsEnum.CUS,
        AppAccessControlsEnum.ACH, AppAccessControlsEnum.AW, AppAccessControlsEnum.AA, AppAccessControlsEnum.AD,
        AppAccessControlsEnum.FMS, AppAccessControlsEnum.ACS, AppAccessControlsEnum.EDC, AppAccessControlsEnum.AP,
    ...
    EXPERT_CONNECT_USER_SANDBOX("APRIORI_EXPERT + CONNECT ADMIN + USER ADMIN + SANDBOX", Arrays.asList(AppAccessControlsEnum.AW, AppAccessControlsEnum.AA,
        ...
        AppAccessControlsEnum.ACS)),
    EXPERT_CONNECT_USER_ADMIN("APRIORI_EXPERT + CONNECT ADMIN + USER ADMIN + EXPORT ADMIN", Arrays.asList(AppAccessControlsEnum.CUS,
        AppAccessControlsEnum.ACH, AppAccessControlsEnum.AW, AppAccessControlsEnum.AA, AppAccessControlsEnum.AD,
        AppAccessControlsEnum.FMS, AppAccessControlsEnum.ACS, AppAccessControlsEnum.EDC, AppAccessControlsEnum.AP,
