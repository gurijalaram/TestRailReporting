...
public class CdsApplicationsTests {
    ...
    public void getApplicationById() {
        Application response = cdsTestUtil.getCommonRequest(CDSAPIEnum.APPLICATION_BY_ID, Application.class, HttpStatus.SC_OK, cdsTestUtil.getApplicationIdentity(AP_PRO))
            .getResponseEntity();
