...
import com.apriori.edcapi.entity.request.PostPartRequest;
...
public class PartsUtil extends TestUtil {
    ...
    public ResponseWrapper<PostPartResponse> postPart(String bomIdentity, String lineItemIdentity) {
        RequestEntity requestEntity =
            RequestEntityUtil.init(EDCAPIEnum.POST_BILL_OF_MATERIALS_LINE_ITEMS_PARTS, PostPartResponse.class)
                .inlineVariables(bomIdentity, lineItemIdentity)
                .body("partsInput",
                    PostPartRequest.builder()
                        .availability("Active")
                        .averageCost("16881.1222")
                        .classification("Connectors > Connector Other > Connector Terminals")
                        .dataSheetUrl("http://www.te.com/usa-en/product-53440-1.html")
                        .description("ELECTRO-TAP, 18-14 AWG RUN TAP")
                        .isUserPart(true)
                        .manufacturer("TE Connectivity")
                        .manufacturerPartNumber("53440.23")
                        .minimumCost("0.4656")
                        .mountType("Cable Mount")
                        .pinCount("5456")
                        .rohs("Yes")
