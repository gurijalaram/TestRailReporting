...
public class AchCustomersTests extends AchTestUtil {
    ...
    public void getCustomers() {
        ...
        ResponseWrapper<CustomersAch> customers = getCommonRequest(ACHAPIEnum.CUSTOMERS, CustomersAch.class, HttpStatus.SC_OK);
