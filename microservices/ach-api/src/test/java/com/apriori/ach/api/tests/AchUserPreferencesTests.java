...
public class AchUserPreferencesTests extends AchTestUtil {
    ...
    public void getPreferences() {
        ResponseWrapper<UserPreferences> userPreferences = getCommonRequest(ACHAPIEnum.USER_PREFERENCES, UserPreferences.class, HttpStatus.SC_OK);
    ...
    public void createUpdateUserPreference() {
        ...
        ResponseWrapper<SuccessUpdatePreferencesResponse> newPreference = putUserPreference(prefName, value, SuccessUpdatePreferencesResponse.class);
        ...
        updatePreferencesByPatch(prefIdentity, newValue);
        ResponseWrapper<UserPreferences> preferences = getSortedUserPreferences();
    ...
    public void updateUserPreference() {
        ...
        String newValue = generateStringUtil.getRandomNumbersStartsNoZero();
        ResponseWrapper<SuccessUpdatePreferencesResponse> updatedPreference = updatePreferencesByPut(prefName, newValue);
    ...
    public void failureUpdatePreference() {
        String prefName = generateStringUtil.getRandomString();
        String value = generateStringUtil.getRandomNumbersStartsNoZero();
        Success successResponse = putUserPreference(prefName, value, SuccessUpdatePreferencesResponse.class)
            .getResponseEntity().getSuccesses().stream().findFirst().get();

        ResponseWrapper<FailureUpdatePreferencesResponse> failureUpdate = putUserPreference(prefName, value, FailureUpdatePreferencesResponse.class);
