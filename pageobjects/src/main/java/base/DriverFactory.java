...
import main.java.properties.reader.BaseReader;
    ...
    private String getDriverLocation(String browser) {
        ...
        if (browser.equalsIgnoreCase("firefox")) {
            if (osLowerCase.contains(Platform.WINDOWS.name().toLowerCase())) {
                driverLocation = new File("../pageobjects/src/main/resources/geckodriver.exe").getAbsolutePath();
            }
        } else if (browser.equalsIgnoreCase("chrome")) {
            if (osLowerCase.contains(Platform.WINDOWS.name().toLowerCase())) {
                driverLocation = new File("../pageobjects/src/main/resources/chromedriver.exe").getAbsolutePath();
            }
        }
