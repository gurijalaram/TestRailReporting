...
import com.apriori.apibase.http.builder.common.response.common.SubmitWorkOredr;
...
import com.apriori.apibase.http.builder.common.response.common.WorkOrderScenarioIteration;
...
public class ScenarioAction {
    ...
    private SubmitWorkOredr doSubmitWorkOrder(WorkOrderScenarioIteration workOrderScenarioIteration) {
        ...
        return (SubmitWorkOredr) new HTTPRequest().unauthorized()
            .customizeRequest()
            .setHeaders(authorizationHeader)
            .setReturnType(SubmitWorkOredr.class)
