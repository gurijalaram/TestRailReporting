        ...
        return new Statement() {
            ...
            public void evaluate() throws Throwable {
                ...
                try {
                    ...
                    if (testBaseNew.getMode().equals(TestMode.LOCAL) || (StringUtils.isNotEmpty(System.getProperty("repeatTests")) && System.getProperty("repeatTests").equalsIgnoreCase("true"))) {
