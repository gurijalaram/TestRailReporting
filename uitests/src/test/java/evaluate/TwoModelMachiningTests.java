...
public class TwoModelMachiningTests extends TestBase {
    ...
    public void testTwoModelMachining() {
        ...
        evaluatePage = loginPage.login(UserUtil.getUser())
            ...
            .selectExploreButton()
            .refreshCurrentPage()
            .uploadFileAndOk(new GenerateStringUtil().generateScenarioName(), twoModelFile)
    ...
    public void testOpenSourceModel() {
        ...
        loginPage = new CIDLoginPage(driver);
        evaluatePage = loginPage.login(UserUtil.getUser())
            .uploadFileAndOk(sourceScenarioName, resourceFile)
            .selectProcessGroup(ProcessGroupEnum.CASTING_DIE.getProcessGroup())
            .costScenario();
    ...
    public void multiLevel2Model() {
        ...
        evaluatePage.selectExploreButton()
            .refreshCurrentPage()
            .uploadFileAndOk(twoModel1ScenarioName, twoModelFile)
            .selectProcessGroup(ProcessGroupEnum.TWO_MODEL_MACHINING.getProcessGroup())
            .selectSourcePart()
            .highlightScenario(sourceScenarioName, sourcePartName)
            .apply(EvaluatePage.class)
        ...
        evaluatePage.selectExploreButton()
            .refreshCurrentPage()
            .uploadFileAndOk(twoModel2ScenarioName, twoModelFile2)
            .selectProcessGroup(ProcessGroupEnum.TWO_MODEL_MACHINING.getProcessGroup())
            .selectSourcePart()
    ...
    public void testOpenPublicSourceModel() {
        ...
        evaluatePage = loginPage.login(UserUtil.getUser())
            ...
            .selectExploreButton()
            .refreshCurrentPage()
            .uploadFileAndOk(twoModelScenarioName, twoModelFile)
            .selectProcessGroup(ProcessGroupEnum.TWO_MODEL_MACHINING.getProcessGroup())
            .selectSourcePart()
            .highlightScenario(sourceScenarioName, sourcePartName)
            .apply(EvaluatePage.class)
    ...
    public void switchSourcePart() {
        ...
        evaluatePage.selectExploreButton()
            .refreshCurrentPage()
            .uploadFileAndOk(source2ScenarioName, twoModelFile)
            .selectProcessGroup(ProcessGroupEnum.CASTING_DIE.getProcessGroup())
            .costScenario()
            .selectExploreButton()
            .refreshCurrentPage()
            .uploadFileAndOk(twoModelScenarioName, twoModelFile2)
            .selectProcessGroup(ProcessGroupEnum.TWO_MODEL_MACHINING.getProcessGroup())
            .selectSourcePart()
            .highlightScenario(sourceScenarioName, sourcePartName)
            .apply(EvaluatePage.class)
