...
public class AddScenarioTests extends TestBase {
    ...
    public void filterAddPrivateScenario() {
        ...
        scenarioTablePage = evaluatePage.createNewComparison().enterComparisonName(new GenerateNameUtil().generateComparisonName())
    ...
    public void filterAddPublicScenario() {
        ...
        scenarioTablePage = loginPage.login(UserUtil.getUser())
            ...
            .selectPublishButton()
            .createNewComparison()
            .enterComparisonName(new GenerateNameUtil().generateComparisonName())
            .save(ComparePage.class)
            .addScenario()
            .filterCriteria()
    ...
    public void comparisonAllCharacters() {
        ...
        String testComparisonName = (new GenerateNameUtil().generateComparisonName() + "!£$%^&*()_+{}~:?><`1-=[]#';|@");
