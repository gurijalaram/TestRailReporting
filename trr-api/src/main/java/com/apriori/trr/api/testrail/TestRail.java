...
import com.apriori.trr.api.testrail.internal.BooleanToIntSerializer;
...
import com.apriori.trr.api.testrail.model.CaseType;
import com.apriori.trr.api.testrail.model.Configuration;
import com.apriori.trr.api.testrail.model.Milestone;
import com.apriori.trr.api.testrail.model.Page;
import com.apriori.trr.api.testrail.model.Plan;
import com.apriori.trr.api.testrail.model.Priority;
...
import com.apriori.trr.api.testrail.model.Section;
import com.apriori.trr.api.testrail.model.Status;
import com.apriori.trr.api.testrail.model.Suite;
import com.apriori.trr.api.testrail.model.Test;
import com.apriori.trr.api.testrail.model.User;
...
public class TestRail {
    ...
    public class Cases {
        ...
        public class List extends Request<java.util.List<Case>> {
            ...
            private java.util.List<CaseField> caseFields;
            @JsonView(List.class)
    ...
    public class Milestones {
         ...
         * @return the request
         * @throws IllegalArgumentException if milestoneId is not positive
         */
         ...
         * @return the request
         * @throws IllegalArgumentException if projectId is not positive
         * @throws NullPointerException     if milestone is null
         */
    ...
    public class Plans {
         ...
         * @return the request
         * @throws IllegalArgumentException if planId is not positive
         */
    ...
    public class Results {
         ...
         * @return the request
         * @throws IllegalArgumentException if testId is not positive
         * @throws NullPointerException     if resultFields is null
         */
         ...
         * @param resultFields the custom result fields configured in TestRail to get type information for custom fields in the results returned
         * @return the request
         * @throws IllegalArgumentException if runId is not positive
         * @throws NullPointerException     if resultFields is null
         */
         ...
         * @return the request
         * @throws IllegalArgumentException if runId or testCaseId is not positive
         * @throws NullPointerException     if any other argument is null
         */
         ...
         * @param resultFields the custom result fields configured in TestRail to get type information for custom fields in the results returned
         * @return the request
         * @throws IllegalArgumentException if runId is not positive or results is empty
         * @throws NullPointerException     if results or resultFields are null
         */
